export function createHttpFlashApi({ baseUrl = "", token = "", getToken = null } = {}) {
  ...
  return {
    ...
    listStoryProjects: () => request("/flash/story-projects"),
    createStoryProject: (project = {}) => post("/flash/story-projects", { project }),
    getStoryProject: (id) => request(`/flash/story-projects/${encode(id)}`),
    ...
    listStoryProjectAssets: (id, options = {}) => request(`/flash/story-projects/${encode(id)}/assets`, { query: options }),
    ...
    listStoryProjectAiJobs: (id, options = {}) => request(`/flash/ai/story-projects/${encode(id)}/jobs`, { query: options }),
    ...
    listAssets: (options = {}) => request("/flash/assets", { query: options }),
