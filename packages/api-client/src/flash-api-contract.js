...
export const FLASH_API_ROUTES = [
  ...
  { id: "storyProjects.compileComic", method: "POST", path: "/flash/story-projects/:id/compile/comic", auth: "user", requestEntity: "StoryProject", responseEntity: "StoryProjectVersion" },
