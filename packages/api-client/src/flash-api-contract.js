...
export const FLASH_API_ROUTES = [
  ...
  { id: "storyProjects.versions.restore", method: "POST", path: "/flash/story-projects/:id/versions/:versionId/restore", auth: "user", responseEntity: "StoryProject" },
  { id: "storyProjects.assets.list", method: "GET", path: "/flash/story-projects/:id/assets", auth: "user", responseEntity: "Asset" },
  ...
  { id: "ai.storyProjectJobs.list", method: "GET", path: "/flash/ai/story-projects/:id/jobs", auth: "user", responseEntity: "AiGenerationJob" },
  ...
  { id: "assets.list", method: "GET", path: "/flash/assets", auth: "user", responseEntity: "Asset" },
  { id: "assets.create", method: "POST", path: "/flash/assets", auth: "user", requestEntity: "Asset", responseEntity: "Asset" },
...
export const MOCK_FLASH_API_METHOD_ROUTES = {
  ...
  restoreStoryProjectVersion: "storyProjects.versions.restore",
  listStoryProjectAssets: "storyProjects.assets.list",
  ...
  listStoryProjectAiJobs: "ai.storyProjectJobs.list",
  ...
  getAsset: "assets.get",
  updateAssetSourceStatement: "assets.source.update",
  submitAssetReview: "assets.review.submit",
