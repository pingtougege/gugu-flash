...
export const REQUIRED_PRODUCTION_INDEXES = [
  ...
  "idx_assets_status",
  "idx_assets_story_project_usage",
  "idx_assets_render_job_id",
  "idx_render_jobs_story_project_status",
  "idx_render_jobs_asset_id",
...
export const JSON_STORE_REPOSITORY_CONTRACTS = [
  ...
  { id: "assets", requiredMethods: ["list", "listForProject", "get", "save"], productionTables: ["assets"] },
  { id: "aiGenerationJobs", requiredMethods: ["list", "listForProject", "get", "save"], productionTables: ["render_jobs"] },
